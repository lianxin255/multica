...
| ZCode | `zcode-acp-server` | [ZCode](https://zcode.z.ai) |
...
For ZCode, install the ZCode desktop app, sign in once in the app, and install the community ACP bridge [zcode-acp-server](https://github.com/william0wang/zcode-acp) (`npm i -g zcode-acp-server`, requires a release that includes william0wang/zcode-acp#38). The bridge drives the runtime the desktop app installed and reuses its credentials, so no separate sign-in is needed.
