  ...
  changelog: {
    ...
    entries: [
      ...
      },
      {
        version: "0.3.39",
        date: "2026-07-06",
        title: "Qoder, Trae CLI, and ZCode as custom runtime bases, plus squad and stability fixes",
        changes: [],
        features: [
